...
[] Number of DE genes in each generation; also, control-vs-control
[] Overlap between lists of DE genes (gene set enrichment)
[] correlation of logFC values between DE in different lists
