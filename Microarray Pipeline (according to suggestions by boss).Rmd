...
#####
createSheet(by_generation2, "rpr.cyo_dilp3.ser_f")
writeWorksheet(by_generation2, rpr.cyo_dilp3.ser_f, "rpr.cyo_dilp3.ser_f")

createSheet(by_generation2, "cyo_ser_f")
writeWorksheet(by_generation2, cyo_ser_f, "cyo_ser_f")

createSheet(by_generation2, "rpr_dilp3_f")
writeWorksheet(by_generation2, rpr_dilp3_f, "rpr_dilp3_f")

createSheet(by_generation2, "cyo_dilp3_f")
writeWorksheet(by_generation2, cyo_dilp3_f, "cyo_dilp3_f")

createSheet(by_generation2, "rpr_ser_f")
writeWorksheet(by_generation2, rpr_ser_f, "rpr_ser_f")

createSheet(by_generation2, "f2_f")
writeWorksheet(by_generation2, f2_f, "f2_f")

createSheet(by_generation2, "f3_f")
writeWorksheet(by_generation2, f3_f, "f3_f")

#####
saveWorkbook(by_generation, "by_generation2.xlsx")
```
