...
geno_1 %>% filter(pval <= 0.05) %>% count()
# 584 DE genes in first generation

geno_2 %>% filter(pval <= 0.05) %>% count()
# 978 DE genes in second generation

geno_3 %>% filter(pval <= 0.05) %>% count()
...
4.   Corrected, w/  FC threshold, w/o p value adj ---    DE genes found in 2nd & 3rd generation
...
1.   Corrected, w/o FC threshold, w/  p value adj ---    DE genes found in 2nd & 3rd generation
...
3.   Corrected, w/  FC threshold, w/  p value adj ---    DE genes found in 2nd & 3rd generation
```{r venn_overlap_w/_adj_w/_FC}
...
8. Uncorrected, w/o FC threshold, w/o p value adj --- no DE genes found in 2nd & 3rd generation
...
5. Uncorrected, w/  FC threshold, w/  p value adj --- no DE genes found in 2nd & 3rd generation
...
2.   Corrected, w/o FC threshold, w/o p value adj ---    DE genes found in 2nd & 3rd generation --- most favorable
4.   Corrected, w/  FC threshold, w/o p value adj ---    DE genes found in 2nd & 3rd generation
1.   Corrected, w/o FC threshold, w/  p value adj ---    DE genes found in 2nd & 3rd generation
3.   Corrected, w/  FC threshold, w/  p value adj ---    DE genes found in 2nd & 3rd generation --- expression plot?
8. Uncorrected, w/o FC threshold, w/o p value adj --- no DE genes found in 2nd & 3rd generation --- most correct
6. Uncorrected, w/  FC threshold, w/o p value adj --- no DE genes found in 2nd & 3rd generation
7. Uncorrected, w/o FC threshold, w/  p value adj --- no DE genes found in 2nd & 3rd generation
5. Uncorrected, w/  FC threshold, w/  p value adj --- no DE genes found in 2nd & 3rd generation
...
```{r filtration}
results <- read_csv("C:/Users/ameek/OneDrive/Desktop/results.csv",
col_types = cols(gener = col_factor(levels = c("g1",
"g2", "g3")), model = col_factor(levels = c("m1",
"m2", "m3", "m4", "m5", "m6", "m7", "m8"))))

ggplot(data = results, aes(x = model, y = genes, fill = gener)) + geom_bar(position = "dodge", stat = "identity") + facet_wrap(~filtration) + coord_cartesian(ylim = c(0, 1200))
```
