...
# If pasted outside the code chunk, the following table will be rendered automatically as an HTML table 
("
+------------+-------+----------------+-----------+------------+------+------+------+-----------------------+
...
+------------+-------+----------------+-----------+------------+------+------+------+-----------------------+
  ...
  read_delim(delim = '|', col_types = "_fffffdddc_") %>% # reads in as a data frame; skips empty colns
...
# The first gener DE genes decrease from m1 to m4, then m5 to m8;
